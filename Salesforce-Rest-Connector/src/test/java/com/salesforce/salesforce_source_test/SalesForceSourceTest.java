...
public class SalesForceSourceTest {
    ...
    public static void beforeClass() {
        ...
        properties.setProperty("ClientID", "3MVG9n_HvETGhr3DY5cNjH9EJ_gXqoUvU8olBacBAGI7.7DVNE4_IM1.mRNk.HkIBAD1ZhlnFSrnTud7VlWFH");
        ...
        properties.setProperty("ClientSecret", "4E620363D59BA7EB5B6F1EDD29B54BD8571AF1A64BB9C6ABC16D8C858AA4EE71");
    ...
    @Test
    public void salesforceProcessQueryExecution() throws Exception {

        salesforce.processQuery("Account", "SELECT+Id+FROM+Account", new ExtDataProcessor() {
